...
namespace LogitechLedCs
{
    ...
    public abstract class LogitechGSDK
    {
        //LED SDK
        ...
        /// <summary>
        /// Specifies an option for LGS and gets the user data
        /// </summary>
        /// <param name="configPath"> Name of the option </param>
        /// <param name="defaultNumber"> Argument double by reference </param>
        /// <returns> True unless bad argument</returns>
        [DllImport("LogitechLedEnginesWrapper.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <summary>
        /// Specifies a color for LGS and gets the user data
        /// </summary>
        /// <param name="configPath"> Name of the color </param>
        /// <param name="defaultNumber"> Argument int channels by reference </param>
        /// <returns> True unless bad argument</returns>
        [DllImport("LogitechLedEnginesWrapper.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </summary>
        /// <param name="configPath"> Name of the color</param>
        /// <param name="defaultColor"> Default option</param>
        /// <returns> Color from LGS </returns>
        public static Color LogiLedGetConfigOptionColor(string configPath, Color defaultColor)
        {
            int red, green, blue;
            red = defaultColor.R;
            green = defaultColor.G;
            blue = defaultColor.B;
            LogiLedGetConfigOptionColor(configPath, ref red, ref green, ref blue);
